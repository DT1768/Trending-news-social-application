...
import { getNewsByCategory, searchNews } from "./helper/newshelper";
            ...
            <div className="container-fluid bg-white text-dark text-center">
                ...
                <div class="input-group m-3">
                    <div class="form-outline">
                        <input type="text" id="form1" class="form-control"  value={keyword} onChange={handleSearch()} placeholder='Search News' />
                    </div>
